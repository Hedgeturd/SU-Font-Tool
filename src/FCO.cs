    ...
    public static class FCO { 
        ...
        /*public static void ReadFCO(string path) {
            ...
            if (Program.tableArg != null) {
                ...
                OLDTranslator.iconsTablePath = Common.fcoTableDir + "Icons.json";
            }
            else {
                ...
                for (int g = 0; g < groupCount; g++) {
                    ...
                    for (int c = 0; c < cellCount; c++) {
                        ...
                        /*  This will add together the following into the Cell Struct:
                            Cell Name, Message, Colour0, Colour1, Colour2 and (possibly) Highlights #1#
                    }
        ...
        public static void WriteXML(string path, FontConverse fcoFile, TranslationTable thing) {
            ...
            foreach (Group group in fcoFile.Groups) {
                ...
                foreach (Cell cell in group.Cells) {
                    ...
                    //writer.WriteAttributeString("MessageData", TranslationService.RawHEXtoTXT(cell.Message, thing.Standard));
